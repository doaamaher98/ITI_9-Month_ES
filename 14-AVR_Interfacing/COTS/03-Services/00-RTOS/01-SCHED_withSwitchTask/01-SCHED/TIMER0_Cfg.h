...
*/   
#define			TIMER0_Wave						TIMER_0_enuCTC_Mode
...
*/
#define			TIMER0_ClockSrc			TIMER_0_enuPrescaler_64
...
*/
#define			TIMER0_Counter			TIMER_0_enuCounterMode_RaisingEdge

/* Options :
   ---------
   TIMER0_NoPrescaler
   TIMER0_WithPrescaler
*/
#define			TIMER0_Clk				TIMER0_WithPrescaler
...
*/
#define			TIMER0_InterruptSrc			TIMER0_CompareMatch_Interrupt_EN
...
/* Options :
   ...
   TIMER0_CompareMatchOFF_FastPWM
*/
#define			TIMER0_CompareMatch_FastPWM_Mode		TIMER0_CompareMatchOFF_FastPWM
...
/* Options :
   ...
   TIMER0_CompareMatchOFF_PhaseCorrect
*/
#define			TIMER0_CompareMatch_PhaseCorrect_Mode	TIMER0_CompareMatchOFF_PhaseCorrect


//#define			TIMER0_CompareMatch_Value				125
