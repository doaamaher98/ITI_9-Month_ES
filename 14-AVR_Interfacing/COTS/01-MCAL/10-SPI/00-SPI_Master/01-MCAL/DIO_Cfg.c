...
DIO_strPinCfg_t DIO_strPinCfg [DIO_enuNumberOfPins] =
{
	...
	/*PIN11*/ {DIO_enuOUTPUT,  DIO_enuOutputLow},			// MASTER //
	/*PIN12*/ {DIO_enuINPUT,  DIO_enuInputPinHighImp},		// PB4 :SS
	/*PIN13*/ {DIO_enuOUTPUT,  DIO_enuOutputLow},			// PB5 :MOSI
	/*PIN14*/ {DIO_enuINPUT,  DIO_enuInputPinPullUp},		// PB6 :MISO
	/*PIN15*/ {DIO_enuOUTPUT,  DIO_enuOutputLow},			// PB7 :SCK
	/*********************************************************************/
