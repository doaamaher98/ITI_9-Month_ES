...
/* Options :
   ...
   TIMER0_TimerMode 
*/
#define			TIMER0_Mode				TIMER0_TimerMode
...
/* Options :
   ...
   TIMER0_InterruptOFF
*/
#define			TIMER0_SysInterrupt		TIMER0_InterruptOFF
...
*/
#define			TIMER0_CompareMatch_NonPWM_Mode			TIMER0_CompareMatchOFF_NonPWM
...
*/
#define			TIMER0_CompareMatch_FastPWM_Mode		TIMER_0_enuCompareMatch_FastClearCM_SetTop
