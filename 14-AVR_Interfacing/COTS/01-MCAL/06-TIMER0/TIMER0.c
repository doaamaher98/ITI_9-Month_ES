...
/****************** OVF *****************/
static u8 TIMER0_PrescalerValue;
static u16 TIMER0_OVFS;
static u8 TIMER0_PreloadValue;
/******************* CTC ****************/
static u16 TIMER0_CompareMatchValue;				// Blink LED each 1 sec
...
// 		TIMER0_TCCR0 = TIMER0_PreloadValue;
	}
	#elif (TIMER0_Wave == TIMER_0_enuPWM_PhaseCorrect_Mode)
	{
		SET_BIT(TIMER0_TCCR0,TIMER0_enuTCCR0_WGM00);
		CLR_BIT(TIMER0_TCCR0,TIMER0_enuTCCR0_WGM01);
		
// 		TIMER0_OCR0 = TIMER0_CompareMatchValue;
	}
	#elif (TIMER0_Wave == TIMER_0_enuCTC_Mode)
	{
		CLR_BIT(TIMER0_TCCR0,TIMER0_enuTCCR0_WGM00);
...
// 		TIMER0_OCR0 = TIMER0_CompareMatchValue;
	...
	#elif (TIMER0_Wave == TIMER_0_enuPWM_Fast_Mode)
	{
		SET_BIT(TIMER0_TCCR0,TIMER0_enuTCCR0_WGM00);
		SET_BIT(TIMER0_TCCR0,TIMER0_enuTCCR0_WGM01);
...
// 		TIMER0_OCR0 = TIMER0_CompareMatchValue;
	...
	#elif (TIMER0_State == TIMER0_ON)
	{
		...
		#else
		LocalErrorStatus = TIMER0_enuInvalidTimer;
		#endif
	}
	// 2- Counter Mode
