...
DIO_tenuErrorStatus DIO_enuSetPort (DIO_tenuPort Cpy_enuPortNumber, u8 Cpy_AssignedPortVal)
{
	...
	else if (Cpy_AssignedPortVal != DIO_enuLow || Cpy_AssignedPortVal != DIO_enuHigh)
	{
		Local_ErrorStatus = DIO_enuInvalidValue;
	}
	...
	else if (Local_ErrorStatus == DIO_enuOK)
	{
		...
		{
			case DIO_enuPORTA:
				ASSIGN_REG(PORTA,Cpy_AssignedPortVal);
				break;
			
			case DIO_enuPORTB:
				ASSIGN_REG(PORTB,Cpy_AssignedPortVal);
				break;
			
			case DIO_enuPORTC:
				ASSIGN_REG(PORTC,Cpy_AssignedPortVal);
				break;
			
			case DIO_enuPORTD:
				ASSIGN_REG(PORTD,Cpy_AssignedPortVal);
				break;
