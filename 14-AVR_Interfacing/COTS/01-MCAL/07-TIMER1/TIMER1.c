...
TIMER1_enuErrorStatus TMR1_enuInitPreCompile(void)
{
	...
	#elif (TIMER1_CMUnit == TIMER_1_Unit_B)
	{
		#if (TIMER1_CompareOutputMode == TIMER1_Non_PWM)
		{
	...
	#else
	LocalErrorStatus = TIMER1_enuInvalidCompareMatch_Mode;
	#endif
	...
	#if (TIMER1_SysInterrupt == TIMER1_InterruptON)
	{
		...
		#else LocalErrorStatus = TIMER1_enuInvalidInterrupt;
		#endif
	}
	
	#else LocalErrorStatus = TIMER1_enuInterruptOFF;
	#endif
