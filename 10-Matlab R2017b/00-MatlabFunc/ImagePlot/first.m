...
% Last Modified by GUIDE v2.5 11-Dec-2022 18:51:28
...
% --- Executes on button press in countup.
function countup_Callback(hObject, eventdata, handles)
% hObject    handle to countup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global count
count = count + 1

set(handles.counterText, 'String', count);


% --- Executes on button press in countdown.
