###########################################################################
## Makefile generated for Simulink model 'IfElse'. 
## 
## Makefile     : IfElse.mk
## Generated on : Sat Dec 31 19:47:10 2022
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/IfElse.exe
...
MODELREF_LINK_RSPFILE_NAME = IfElse_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = IfElse_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/IfElse.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/IfElse_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=IfElse -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/IfElse_ert_rtw/IfElse.c

MAIN_SRC = $(START_DIR)/IfElse_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/IfElse_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
