...
this.def["UpCounter_DW"] = {file: "UpCounter_c.html",line:23,type:"var"};
this.def["UpCounter_U"] = {file: "UpCounter_c.html",line:26,type:"var"};
this.def["UpCounter_Y"] = {file: "UpCounter_c.html",line:29,type:"var"};
this.def["UpCounter_M_"] = {file: "UpCounter_c.html",line:32,type:"var"};
this.def["UpCounter_M"] = {file: "UpCounter_c.html",line:33,type:"var"};
this.def["UpCounter_step"] = {file: "UpCounter_c.html",line:36,type:"fcn"};
this.def["UpCounter_initialize"] = {file: "UpCounter_c.html",line:63,type:"fcn"};
this.def["UpCounter_terminate"] = {file: "UpCounter_c.html",line:82,type:"fcn"};
this.def["DW_UpCounter_T"] = {file: "UpCounter_h.html",line:42,type:"type"};
this.def["ExtU_UpCounter_T"] = {file: "UpCounter_h.html",line:48,type:"type"};
this.def["ExtY_UpCounter_T"] = {file: "UpCounter_h.html",line:53,type:"type"};
this.def["RT_MODEL_UpCounter_T"] = {file: "UpCounter_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["UpCounter_c.html"] = "../UpCounter.c";
	this.html2Root["UpCounter_c.html"] = "UpCounter_c.html";
	this.html2SrcPath["UpCounter_h.html"] = "../UpCounter.h";
	this.html2Root["UpCounter_h.html"] = "UpCounter_h.html";
	this.html2SrcPath["UpCounter_private_h.html"] = "../UpCounter_private.h";
	this.html2Root["UpCounter_private_h.html"] = "UpCounter_private_h.html";
	this.html2SrcPath["UpCounter_types_h.html"] = "../UpCounter_types.h";
	this.html2Root["UpCounter_types_h.html"] = "UpCounter_types_h.html";
...
var fileList = [
"ert_main_c.html","UpCounter_c.html","UpCounter_h.html","UpCounter_private_h.html","UpCounter_types_h.html","rtwtypes_h.html"];
