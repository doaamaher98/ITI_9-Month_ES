...
this.def["While_Counter_DW"] = {file: "While_Counter_c.html",line:23,type:"var"};
this.def["While_Counter_U"] = {file: "While_Counter_c.html",line:26,type:"var"};
this.def["While_Counter_Y"] = {file: "While_Counter_c.html",line:29,type:"var"};
this.def["While_Counter_M_"] = {file: "While_Counter_c.html",line:32,type:"var"};
this.def["While_Counter_M"] = {file: "While_Counter_c.html",line:33,type:"var"};
this.def["While_Counter_step"] = {file: "While_Counter_c.html",line:36,type:"fcn"};
this.def["While_Counter_initialize"] = {file: "While_Counter_c.html",line:71,type:"fcn"};
this.def["While_Counter_terminate"] = {file: "While_Counter_c.html",line:90,type:"fcn"};
this.def["DW_While_Counter_T"] = {file: "While_Counter_h.html",line:42,type:"type"};
this.def["ExtU_While_Counter_T"] = {file: "While_Counter_h.html",line:48,type:"type"};
this.def["ExtY_While_Counter_T"] = {file: "While_Counter_h.html",line:53,type:"type"};
this.def["RT_MODEL_While_Counter_T"] = {file: "While_Counter_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["While_Counter_c.html"] = "../While_Counter.c";
	this.html2Root["While_Counter_c.html"] = "While_Counter_c.html";
	this.html2SrcPath["While_Counter_h.html"] = "../While_Counter.h";
	this.html2Root["While_Counter_h.html"] = "While_Counter_h.html";
	this.html2SrcPath["While_Counter_private_h.html"] = "../While_Counter_private.h";
	this.html2Root["While_Counter_private_h.html"] = "While_Counter_private_h.html";
	this.html2SrcPath["While_Counter_types_h.html"] = "../While_Counter_types.h";
	this.html2Root["While_Counter_types_h.html"] = "While_Counter_types_h.html";
...
var fileList = [
"ert_main_c.html","While_Counter_c.html","While_Counter_h.html","While_Counter_private_h.html","While_Counter_types_h.html","rtwtypes_h.html"];
