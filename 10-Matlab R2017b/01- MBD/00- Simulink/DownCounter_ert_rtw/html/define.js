...
this.def["DownCounter_DW"] = {file: "DownCounter_c.html",line:23,type:"var"};
this.def["DownCounter_U"] = {file: "DownCounter_c.html",line:26,type:"var"};
this.def["DownCounter_Y"] = {file: "DownCounter_c.html",line:29,type:"var"};
this.def["DownCounter_M_"] = {file: "DownCounter_c.html",line:32,type:"var"};
this.def["DownCounter_M"] = {file: "DownCounter_c.html",line:33,type:"var"};
this.def["DownCounter_step"] = {file: "DownCounter_c.html",line:36,type:"fcn"};
this.def["DownCounter_initialize"] = {file: "DownCounter_c.html",line:63,type:"fcn"};
this.def["DownCounter_terminate"] = {file: "DownCounter_c.html",line:82,type:"fcn"};
this.def["DW_DownCounter_T"] = {file: "DownCounter_h.html",line:42,type:"type"};
this.def["ExtU_DownCounter_T"] = {file: "DownCounter_h.html",line:48,type:"type"};
this.def["ExtY_DownCounter_T"] = {file: "DownCounter_h.html",line:53,type:"type"};
this.def["RT_MODEL_DownCounter_T"] = {file: "DownCounter_types_h.html",line:23,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["DownCounter_c.html"] = "../DownCounter.c";
	this.html2Root["DownCounter_c.html"] = "DownCounter_c.html";
	this.html2SrcPath["DownCounter_h.html"] = "../DownCounter.h";
	this.html2Root["DownCounter_h.html"] = "DownCounter_h.html";
	this.html2SrcPath["DownCounter_private_h.html"] = "../DownCounter_private.h";
	this.html2Root["DownCounter_private_h.html"] = "DownCounter_private_h.html";
	this.html2SrcPath["DownCounter_types_h.html"] = "../DownCounter_types.h";
	this.html2Root["DownCounter_types_h.html"] = "DownCounter_types_h.html";
...
var fileList = [
"ert_main_c.html","DownCounter_c.html","DownCounter_h.html","DownCounter_private_h.html","DownCounter_types_h.html","rtwtypes_h.html"];
