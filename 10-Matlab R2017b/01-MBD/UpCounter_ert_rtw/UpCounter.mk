###########################################################################
## Makefile generated for Simulink model 'UpCounter'. 
## 
## Makefile     : UpCounter.mk
## Generated on : Sat Dec 31 17:01:10 2022
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/UpCounter.exe
...
MODELREF_LINK_RSPFILE_NAME = UpCounter_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = UpCounter_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/UpCounter.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/UpCounter_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/UpCounter_ert_rtw/UpCounter.c

MAIN_SRC = $(START_DIR)/UpCounter_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/UpCounter_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
