###########################################################################
## Makefile generated for Simulink model 'Saturation'. 
## 
## Makefile     : Saturation.mk
## Generated on : Fri Jan 06 01:18:46 2023
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Saturation.exe
...
MODELREF_LINK_RSPFILE_NAME = Saturation_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Saturation_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Saturation.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Saturation_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Saturation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/Saturation_ert_rtw/Saturation.c

MAIN_SRC = $(START_DIR)/Saturation_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Saturation_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
