###########################################################################
## Makefile generated for Simulink model 'StateFloww'. 
## 
## Makefile     : StateFloww.mk
## Generated on : Fri Jan 06 00:49:47 2023
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/StateFloww.exe
...
MODELREF_LINK_RSPFILE_NAME = StateFloww_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = StateFloww_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/StateFloww.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/StateFloww_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=StateFloww -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/StateFloww_ert_rtw/StateFloww.c

MAIN_SRC = $(START_DIR)/StateFloww_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/StateFloww_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
