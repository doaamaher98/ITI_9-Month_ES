...
LED_tenuErrorStatus LED_enuSetLEDValue (u8 Led, LED_tenuActiveStatus Cpy_u8LEDVal)
{
	...
	GPIO_enuSetPinValue_(LED_tstrConfig[Led].LED_Port, LED_tstrConfig[Led].LED_Pin, Cpy_u8LEDVal ^ LED_tstrConfig[Led].LED_ActiveStatus);

	return LocalErrorStatus;
}
/**********************************************************************************/

LED_tenuErrorStatus LED_enuLEDToggle (u8 Led , u8 Led_State)
{
	LED_tenuErrorStatus LocalErrorStatus = LED_enuOK;

	GPIO_enuGetPinValue(LED_tstrConfig[Led].LED_Port, LED_tstrConfig[Led].LED_Pin, &Led_State);

	LED_enuSetLEDValue(LED_tstrConfig[Led].LED_Pin,Led_State^1);
